        ...
        <div class="card mg-b-20">
            <div class="card-header pb-0">
                ...
                <a class="modal-effect btn btn-outline-primary" data-effect="effect-scale" data-toggle="modal"
                    href="#modaldemo8">Add tag</a>

                @include('admin.tags.add_modal')
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="modal-effect btn btn-sm btn-info" data-effect="effect-scale"
                                            data-toggle="modal" href="#exampleModal2{{ $tag->id }}"
                                            title="edit">
                                        ...
                                        <a class="modal-effect btn btn-sm btn-danger" data-effect="effect-scale"
                                            data-toggle="modal" href="#modaldemo9{{ $tag->id }} " title="delete">
                                            delete
                                        </a>
                                    </td>
                                </tr>
                                @include('admin.tags.delete_modal', ['tag' => $tag])
                                @include('admin.tags.edit_modal', ['tag' => $tag])
                            @endforeach
                        </tbody>
                    </table>
                </div>
