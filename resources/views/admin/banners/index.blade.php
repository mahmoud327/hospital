    ...
    <div class="col-xl-12">
        <div class="card mg-b-20">
            <div class="card-header pb-0">
                ...
                @include('admin.banners.add_modal')
                        ...
                        <tbody class="tr">
                            @foreach ($banners as $banner)
                                <tr>
                                    ...
                                    <td>
                                        <img src="{{ $banner->image_path }}" height="50px" width="60px">
                                    </td>
                                    <td>{{ $banner->title }}</td>
                                    <td>
                                        <a class="modal-effect btn btn-sm btn-info" data-effect="effect-scale"
                                            data-toggle="modal" href="#exampleModal2{{ $banner->id }}"
                                            title="edit">
                                ...
                                @include('admin.banners.delete_modal', ['banner' => $banner])
                                @include('admin.banners.edit_modal', ['banner' => $banner])
                            @endforeach
                        </tbody>
                    </table>
                </div>
