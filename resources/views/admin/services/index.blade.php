        ...
        <div class="card mg-b-20">
            <div class="card-header pb-0">
                ...
                <a class="modal-effect btn btn-outline-primary" data-effect="effect-scale" data-toggle="modal"
                    href="#modaldemo8">Add Service</a>

                @include('admin.services.add_modal')
                        ...
                        <tbody class="tr">
                            @foreach ($services as $service)
                                <tr>
                                    ...
                                    <td>
                                        <img src="{{ $service->image_path }}" height="50px" width="60px">
                                    </td>
                                    <td>{{ $service->name }}</td>
                                    <td>
                                        ...
                                        <a href="{{ route('service.sub-services', $service->id) }}"
